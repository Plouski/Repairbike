    ...
    <div class='container'>
      <form action ='' method='post'>
        <div class='form-group'>
          ...
          <label>J'ai lu et j'accepte les termes et conditions</label>
        </div>
        <div class='form-group'>
          <button class='form-control btn-larger btn-primary' name='devenirreparateur' required>Devenir un Reparateur</button><br>
