...
if (isset($_GET['id'])){
  ...
  ?>
<body>
  <h1 style="color:white">Annulation du RDV</h1>
  <div class="container">
    <form action="refuser_post.php" method='post'>
      ...
      <input type="submit" value="Annuler"class="btn btn-danger" onclick="return confirm('Vous êtes vraiment sûr(e) pour annuler ce RDV ?');"></a>
